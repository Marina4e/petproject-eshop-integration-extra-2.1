...
import com.example.eshopforintegration.domain.OrderDetails;
...
public class SpringOrdersClient {
    public static void main(String[] args) {
        ...
        OrderIntegrationConfig config = context.getBean("orderIntegrationConfig",
        ...
        list.add(OrderDetails.builder()
                .product("Milk").price(10.0).amount(2.0).sum(20.0).build());
        list.add(OrderDetails.builder()
                .product("Tea").price(50.0).amount(2.0).sum(100.0).build());
